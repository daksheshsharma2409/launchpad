...
export const FeedSection = ({ title, description, opportunities, emptyMessage = "No opportunities found.", isLoading = false }) => {
  return (
    <div className="w-full">
      {title && (
        <div className="mb-8">
          <h1 className="font-display font-black text-5xl md:text-6xl text-[#111111] mb-2 tracking-tight">{title}</h1>
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center min-h-[300px] w-full gap-4">
          <svg className="animate-spin h-10 w-10 text-[#2563eb]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            <circle className="opacity-20" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
            <path className="opacity-80" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
          </svg>
          <p className="text-sm text-[#6b7280] font-medium tracking-wide">Loading opportunities...</p>
        </div>
        ...
        <div className="bg-white/70 backdrop-blur border-2 border-[#e5e7eb] rounded-2xl p-16 text-center flex flex-col items-center justify-center min-h-[300px]">
